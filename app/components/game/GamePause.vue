...
<template>
  <div class="grid grid-cols-2 items-stretch gap-4 max-w-2xl mx-auto">
    <Transition name="slide-side" appear>
      <UCard :ui="{ root: 'col-span-2 dark:bg-default', body: 'p-4 sm:p-4 relative h-64 lg:h-80 flex flex-col items-center justify-center text-dimmed' }">
    ...
    <TransitionGroup
      name="slide-up"
      tag="div"
      class="col-span-2 grid grid-cols-2 items-stretch gap-4"
      appear
    >
      <div key="pause-stop">
        <BaseCardButton
